...
function Sidebar() {
    return (
        <div className='sidebar app-sidebar'>
            ...
            <Link to="/musicas" className="sidebar-item"><i className='fa-solid fa-music' /><p className='link-label'>Músicas</p></Link>
            <Link to="/explorar" className="sidebar-item"><i className='fa-solid fa-search' /><p className='link-label'>Explorar</p></Link>
